...
export default function SecondView() {
  return (
    <div className=' w-screen h-[900px] pb-[100px]'>
      <div className='w-[1000px] mx-auto h-[700px] flex'>
        <div className='h-full border-red-600 w-[500px] flex flex-col justify-center'>
          <div><p className='text-[30px] leading-9'>Czym jest fotowoltaika od<br></br> <b>Solar Garden?</b></p></div>
          <div className='bg-[#a7e06a]/[0.7] h-[5px] w-[50vw] -ml-[20vw] mt-[8px] mb-[20px]'></div>
