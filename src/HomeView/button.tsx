...
export default function Button() {
  ...
  return (
    <div className='w-screen h-[11vh] md:h-auto flex justify-center border-red-900'>
        <div className='w-[90vw] md:w-[1150px] md:h-[100px] flex justify-start items-center'>
            ...
            <div ref={photovoltaic} className='bg-transparent rounded-[10px] w-full md:w-[200px] h-[60px] md:h-[70px] border-gray-900 flex flex-col md:flex-row justify-center items-center md:text-[15px] leading-6 md:border-l mx-[2px] transition-colors'>
            ...
            <div ref={heatPump} className='bg-transparent rounded-[10px] w-full md:w-[200px] h-[60px] md:h-[70px] border-gray-900 flex flex-col md:flex-row justify-center items-center md:text-[15px] leading-6 md:border-l mx-[2px] transition-colors'>
                <TbWindmill className='text-[40px] md:text-[60px]  mx-[10px]'/>
                <p className='text-center text-[12px] leading-4'>Pompy <br></br>Ciepła</p>
            </div>
            <div ref={energyBank} className='bg-transparent rounded-[10px] w-full md:w-[200px] h-[60px] md:h-[70px] border-gray-900 flex flex-col md:flex-row justify-center items-center md:text-[15px] leading-6 md:border-l mx-[2px] transition-colors'>
