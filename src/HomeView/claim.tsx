...
export default function Claim() {
  return (
    <div className='relative w-screen flex h-[65vh] justify-center items-center top-[50px]'>
    <div className='w-[1150px] h-[350px] z-10 text-[100px] mx-auto top-[12%]'>
        <div className='flex flex-col mb-[2px] xl:mb-[10px]'>
            <h1 className='text-[30px] xl:text-[45px] leading-6 xl:leading-10'>Fotowoltaika</h1>
            <p className='text-[10px] xl:text-[20px] leading-6 xl:leading-10 text-[#a7e06a] ml-[15px]'>dofinansowanie do <b>7 000 zł</b></p>
        </div>
        <div className='flex flex-col mb-[2px] xl:mb-[10px]'>
            <h1 className='text-[30px] xl:text-[45px] leading-6 xl:leading-10'>Pompy Ciepła</h1>
            <p className='text-[10px] xl:text-[20px] leading-6 xl:leading-10 text-[#a7e06a] ml-[15px]'>dofinansowanie do <b>19 400 zł</b></p>
        </div>
        <div className='flex flex-col'>
            <h1 className='text-[30px] xl:text-[45px] leading-10'>Magazyny energii</h1>
