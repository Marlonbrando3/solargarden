    ...
    <div className=' w-screen h-[700px] pb-[100px]'>
      <div className='w-[1000px] mx-auto h-full flex'>
        <div className='h-full border-yellow-600 w-[500px] flex justify-center items-center relative'>
          <div className='absolute bg-[#56BA46] w-[1100px] h-[580px] border-[rgb(167,224,106)] pl-[540px] top-[30px] -left-[45vw] rounded-[20px] shadow-xl text-white text-[16px] flex flex-col justify-center'>
          <form>
            <div className='flex flex-col'>
              <label>Imię i nazwisko*</label>
              <input className='bg-white w-[400px] h-[40px] mb-[10px] rounded-[5px] text-black' required></input>
            </div>
            <div className='flex flex-col'>
            ...
            <div className='flex flex-col mb-[10px] '>
              <label>Adres email</label>
              <textarea className='bg-white w-[400px] h-[120px] rounded-[5px] text-black'></textarea>
            </div>
            <div className='flex'>
        ...
        <div className='h-full w-[500px] flex flex-col justify-center'>
          <div><p className='text-[30px] leading-9'>Skontaktuj się z nami lub<br></br> poproś o bezpłatną ofertę</p>
          </div>
          <div className='bg-[#a7e06a]/[0.7] h-[5px] w-[50vw] -ml-[20vw] mt-[8px] mb-[10px]'></div>
          <p>Solar Garden marka Onesta Group Sp z o.o</p>
          <p>46-100 Namysłów,,<br></br> ul. Oleśnicka 13B</p>
          <p>-</p>
          <p>kontakt@solargarden.com.pl</p>
          <p>+48 669 75 25 25</p>
          <p className='mt-[40px]'></p>
          <p>Adres rejestrowy firmy:</p>
