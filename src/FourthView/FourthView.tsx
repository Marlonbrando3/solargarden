...
export default function ThirdView() {
  ...
  return (
    <div className='md:block w-screen md:h-[700px] pb-[100px]'>
      <div className='w-[90vw] md:w-[1000px] mx-auto h-full md:flex'>
        ...
        <div className='h-full border-yellow-600 w-[90vw] md:w-[500px] flex justify-center items-start md:relative'>
          <div className='md:absolute bg-[#56BA46] w-[90vw] md:w-[1100px] md:h-[580px] border-[rgb(167,224,106)] top-[30px] -right-[45vw] rounded-[20px] shadow-xl text-white text-[16px] flex justify-center border mt-[20px] md:mt-auto'>
            ...
            <div data-name="2" className={descriptions[1].status === false ? 'hidden duration-300' : 'text-[12px] w-[88vw] md:w-[54%] h-[95%] md:ml-[15px] m-[10px] flex flex-col justify-between duration-300'}><p><b>Pompa ciepła powinna być urządzeniem komplementarnym z instalacją fotowoltaiczną i rozwiązuje kilka problemów.</b><br></br><br></br>
            ...
            <div className='mt-[30px] border border-white py-[9px] text-[18px] bg-white text-center md:w-[350px] text-black rounded-[10px] hover:bg-white hover:text-green-700 duration-150 cursor-pointer'>Zamiawiam bezpłatną wycenę</div>
            </div>

            <div data-name="3" className={descriptions[2].status === false ? ' md:w-[54%] h-[95%] ml-[15px] hidden duration-300' : 'text-[12px] m-[10px] w-[88vw] md:w-[54%] h-[95%] md:ml-[15px] px-[10px] flex flex-col justify-between duration-300'}><p><b>Magazyn energii powodują, że jesteś bardziej niezależny.</b><br></br><br></br>
            ...
            <div data-name="3" className={descriptions[3].status === false ? 'w-[54%] h-[95%] ml-[15px] hidden duration-300' : ' text-[12px] w-[88vw] m-[10px] md:w-[54%] h-[95%] md:ml-[15px] mx-[10px] flex flex-col flex-between duration-300'}><p>Instalacja fotowoltaiczna z magazynem energii to jedno z mądrzejszch rozwiązań.<br></br><br></br>
            ...
            <div data-name="3" className={descriptions[4].status === false ? ' w-[54%] h-[95%] ml-[15px] hidden duration-300' : ' text-[12px] w-[88vw] m-[10px] md:w-[54%] h-[95%] md:ml-[15px] mx-[10px] flex flex-col flex-between duration-300'}>Segment w trakcie budowy, skontaktuj się z nami po więcej informacji
            <div className='mt-[30px] border border-white py-[9px] text-[18px] bg-white text-center md:w-[350px] text-black rounded-[10px] hover:bg-white hover:text-green-700 duration-150 cursor-pointer'>Zamiawiam bezpłatną wycenę</div></div>
            <div data-name="3" className={descriptions[5].status === false ? 'w-[54%] h-[95%] ml-[15px] hidden' : ' text-[12px] w-[88vw] m-[10px] md:w-[54%] h-[95%] md:ml-[15px] mx-[10px]'}>Mimo opinii, że firmy nijak nie mają możliwości skorzystania z dofinansowań to <b>mamy autorskie rozwiązania, które pozwalają aby inwestycja w instalację fotowoltaiczną na Twojej firmie była ok 25% tańsza od średnich cen rynkowych.</b> Współpracujmy głównie z dużymi zakładami produkcyjnymi i firmami zatrudniającymi min 30 osób. Możemy przedstawić Ci nasze rozwiązania. Zapraszamy do kontaktu po więcej informacji.
