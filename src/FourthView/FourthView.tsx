      ...
      <div className='w-[1000px] mx-auto h-full flex'>
        ...
        <div className='h-full border-yellow-600 w-[500px] flex justify-center items-center relative'>
          <div className='absolute bg-[#56BA46] w-[1100px] h-[580px] border-[rgb(167,224,106)] top-[30px] -right-[45vw] rounded-[20px] shadow-xl text-white text-[16px] flex flex-col justify-center'>
            ...
            <div className={descriptions[0].status === false ? ' w-[54%] h-[95%] ml-[15px] hidden duration-300' : ' w-[54%] h-[95%] ml-[15px] flex flex-col justify-between duration-300'}><p><b>Zasada działania Instalacji fotowoltaicznej jest prosta dlatego łatwo można ją zrozumieć.</b><br></br><br></br>Panele fotowoltaiczne instalowane na dachu naszych domów lub firm poprzez ekspozycję na słońce generują prąd stały &ldquo;(DC), który jest przekazywany do falownik w naszej instalacji i zostaje zamieniony na prąd zmienny (AC). Prąd zmienny zatem dokładnie taki sam jaki możemy otrzymać z elektrownii i jaki zasila nasze urządzenia domowe na codzień. W okresach wiosennych i letnich instalacja produkuje dla nas zdecydowanie więcej energii niż potrzebujemy w tym konkretnym momencie, dlatego nadwyżka musi zostać gdzieś magazynowana w tym przypadku w zakładzie energetycznym, który pełni rolę magazynu, choć po zmianie przepisów częściej używamy słowa "portfel" dlatego, że owa nadwyżka jest właściwie sprzedawana, po czym kwota za którą energia została sprzedana zasila nasz "wirtualny portfel". W miesiąch zimowych środki zgromadzone w tym portfelu służą nam do zakupu energii ponieważ w tym okresie instalacja fotowoltaiczna produkuje marginalne, niewystarczające na potrzebny ilości prądu. Obecnie dofinansowania do instalacji fotowoltaicznej sięgają 7000 zł.</p>  
            ...
            <div className={descriptions[1].status === false ? ' w-[54%] h-[95%] ml-[15px] hidden duration-300' : ' w-[54%] h-[95%] ml-[15px] flex flex-col justify-between duration-300'}><p><b>Pompa ciepła powinna być urządzeniem komplementanym z instalacją fotowoltaiczną i rozwiązuje kilka problemów.</b><br></br><br></br>
            ...
            Panele fotowoltaiczne instalowane na dachu naszych domów lub firm poprzez ekspozycję na słońce generują prąd stały (DC), który jest przekazywany do falownik w naszej instalacji i zostaje zamieniony na prąd zmienny (AC). Prąd zmienny zatem dokładnie taki sam jaki możemy otrzymać z elektrownii i jaki zasila nasze urządzenia domowe na codzień. W okresach wiosennych i letnich instalacja produkuje dla nas zdecydowanie więcej energii niż potrzebujemy w tym konkretnym momencie i wtedy gdy nasza instalacja posiada magazyn energii to w pierwszej kolejności nadwyżki magazynowane są właśnie tam. Dopiero jak nasz magazyn energii zapełni się, a nadwyżki dalej będą produkowane będą one oddane do zakładu energetycznego. Magazyn zwiększa zatem ilość energii, która jest zużywana bez konieczności "wyjścia na zewnątrz" czyli na rzecz tzw. autokonsumpcji. Wartość ta zostaje podniesiona z ok. 25-30% do 50-60%, więc praktycznie dwa razy więcej energii zostaje w naszym ekosystemie na jesienne i ziomowe dni w których produkcja jest bardzo niska.</p>
            <div className='mt-[30px] border border-white py-[9px] text-[18px] bg-white text-center w-[350px] text-black rounded-[10px] hover:bg-white hover:text-green-700 duration-150 cursor-pointer '>Zamiawiam bezpłatną wycenę</div>
            </div>
